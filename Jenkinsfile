...
pipeline {
    ...
    stages {
            ...
            steps {
                script {
                    withDockerRegistry(credentialsId: 'DockerHub-Credential', toolName: 'docker') {
                        sh "docker build -t koladams/frontendservice:latest ."
                    }
                }
            }
        }
        ...
        //             sh 'ssh -o StrictHostKeyChecking=no ubuntu@18.224.31.11 "docker run -t zaproxy/zap-weekly zap-baseline.py -t http://18.118.130.161:30000/" || true'
    ...
    always {
        ...
        slackSend channel: '#general', //co--multi-microservices-alerts
